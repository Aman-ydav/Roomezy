          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickActions.map((action, idx) => (
              ...
              >
                <Card
                  className={`
                    p-6 border border-border bg-card hover:shadow-md transition-all
                    text-center ${action.bgColor} ${
            ...
            {recentPosts.length > 0 ? (
              <div className="space-y-4">
                {recentPosts.map((post) => (
                  <div key={post._id} className="flex items-start space-x-4 p-4 border border-border rounded-lg bg-muted/10">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-muted-foreground mb-2">
                        <span className="flex items-center space-x-1">
                          ...
                          <span>{post.averageRating ? post.averageRating.toFixed(1) : 0} rating</span>
                        </span>
